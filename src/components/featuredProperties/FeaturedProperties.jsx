...
const HomeCard = ({ home }) => {
    return (
      ...
      <img className="product-card__image" src={home.imageUrl} alt={home.fpName} />
      <p className="product-card__brand">{home.title}</p>
      <p className="product-card__description">{home.description}</p>
      <p>{home.fpCity}</p>
      <p className="product-card__price">{home.price}</p>
